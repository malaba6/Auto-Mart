...
describe('POST /api/v1/auth/signin', () => {
  it('Should return 417 error message if user tries to login with invalid email', (done) => {
    const user = {
...
describe('POST /api/v1/auth/signin', () => {
  it('Should return 417 error message if user tries to login with wrong type for email', (done) => {
    const user = {
...
describe('POST /api/v1/auth/signin', () => {
  it('Should return 417 error message if user tries to login with short password', (done) => {
    const user = {
  ...
  it('Should return 401 error message if user tries to login with wrong email', (done) => {
    ...
    chai.request(app)
      ...
      .end((err, res) => {
        ...
        expect(res.body.message).to.deep.equal('Email or password Incorrect');
